  ...
  WebGLHeatmap = (function () {
    function WebGLHeatmap(_arg) {
      ...
      if (gradientTexture) {
        ...
        getColorFun = `vec3 getColor(float intensity){\n    
          vec3 blue = vec3(0.0, 0.0, 1.0);\n    
          vec3 cyan = vec3(0.8, 0.6, 1);\n    
          vec3 green = vec3(0.0, 1.0, 0.0);\n    
          vec3 yellow = vec3(1.0, 1.0, 0.0);\n    
          vec3 red = vec3(1.0, 0.0, 0.0);\n\n    
          vec3 color = (\n        
            smoothstep(0.25, 0.5, intensity)*cyan +\n        
            smoothstep(0.5, 0.75, intensity)*green +\n        
            smoothstep(0.75, 0.9, intensity)*yellow +\n        
            smoothstep(0.9, 1.0, intensity)*red\n    
            );\n    
          return color;\n
        }`
      }
